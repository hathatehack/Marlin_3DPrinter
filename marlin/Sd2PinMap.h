...
//------------------------------------------------------------------------------
#elif defined(ARDUINO_STM32_F103VB) \
    ||defined(ARDUINO_ARCH_STM32F10X)
// STM

// Two Wire (aka I2C) ports
//const uint8_t SDA_PIN = 20;  // D1
//const uint8_t SCL_PIN = 21;  // D0

#undef MOSI_PIN
#undef MISO_PIN
// SPI port
const uint8_t SS_PIN = SPI_SS;//53;    // B0
const uint8_t MOSI_PIN = SPI_MOSI;//51;  // B2
const uint8_t MISO_PIN = SPI_MISO;//50;  // B3
const uint8_t SCK_PIN = SPI_SCK;//52;   // B1
